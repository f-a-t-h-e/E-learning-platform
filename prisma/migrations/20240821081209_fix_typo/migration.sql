/*
  ...
  - The values [avaialble] on the enum `CourseState` will be removed. If these variants are still used in the database, this will fail.
  - The values [avaialble] on the enum `LessonState` will be removed. If these variants are still used in the database, this will fail.
  - The values [avaialble] on the enum `QuizState` will be removed. If these variants are still used in the database, this will fail.
  - The values [avaialble] on the enum `UnitState` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CourseState_new" AS ENUM ('created', 'available', 'calculatedGrades');
...
-- AlterEnum
BEGIN;
CREATE TYPE "LessonState_new" AS ENUM ('created', 'available', 'calculatedGrades');
...
-- AlterEnum
BEGIN;
CREATE TYPE "QuizState_new" AS ENUM ('created', 'available', 'calculatedGrades');
...
-- AlterEnum
BEGIN;
CREATE TYPE "UnitState_new" AS ENUM ('created', 'available', 'calculatedGrades');
