...
import { role, user, session, userProfile, course, courseEnrollment, courseInstructor, courseMedia, unit, lesson, lessonContent, quiz, quizMetaData, quizQuestion, quizQuestionOption, quizSubmission, quizAnswer, courseProgress, courseAttendance, courseCertificate } from "./tables";
...
export const quizQuestionOptionRelations = relations(quizQuestionOption, ({one, many}) => ({
...
export const quizSubmissionRelations = relations(quizSubmission, ({one, many}) => ({
	quiz: one(quiz, {
...
export const courseCertificateRelations = relations(courseCertificate, ({one}) => ({
	course: one(course, {
